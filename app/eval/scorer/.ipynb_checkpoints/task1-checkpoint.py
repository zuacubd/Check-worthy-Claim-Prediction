...
if __name__ == '__main__':
    ...
    print (os.getcwd())
    eval_folder = os.getcwd() + '/evaluation/model_ranked_scores'
    ...
    if validate_files(pred_files, gold_files):
        ...
        for (pred_file, gold_file) in zip(pred_files, gold_files):
            ...
            #test_file_no, ml model, and feature combination
            
            feature_comb = pred_file.split('/')[1]
            parts = pred_file.split('/')[2].split('_')
            file_no = parts[0]
